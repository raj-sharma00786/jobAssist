      ...
      >
        ...
        <div className="hidden md:flex flex-col justify-between w-[440px] bg-surface p-12 relative overflow-hidden border-r border-outline-variant">
          ...
          <div className="relative z-20">
            ...
            <p className="text-lg text-body leading-relaxed max-w-[320px]">
              Pick up right where you left off. Your progress, streaks, and prep data are waiting for you.
            </p>
          </div>
          ...
          <div className="relative z-20 space-y-4">
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: "🔥", label: "18-Day Streak", sub: "Keep it going" },
                { icon: "📈", label: "247 Solved", sub: "This month" },
                { icon: "🎯", label: "3 Drives", sub: "Coming up" },
                { icon: "⚡", label: "92% ATS", sub: "Resume score" },
              ].map((b, i) => (
        ...
        <div className="flex-1 flex flex-col justify-center px-8 md:px-14 py-10 bg-surface-container-low">
          ...
          <div className="mb-8 text-center md:text-left">
            <h2 className="text-2xl font-bold text-display mb-2 tracking-tight">Sign In to Your Account</h2>
            <p className="text-sm text-body">Continue instantly with your Google account.</p>
          </div>
          ...
          <p className="text-xs text-body opacity-80 text-center mt-4 leading-relaxed max-w-sm mx-auto">
            We use Google for secure, passwordless authentication. Your data is always protected.
          </p>

          <p className="text-sm text-body text-center mt-8">
            Don&apos;t have an account?{" "}
            <Link href="/signup" className="text-primary font-bold hover:opacity-80 transition-opacity ml-1">
              Create Account
            </Link>
          </p>
